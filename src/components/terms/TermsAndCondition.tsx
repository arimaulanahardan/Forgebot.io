...
const TermsAndConditions = () => {
    return (
        <div className="flex flex-col justify-between items-center rounded-[4px] my-20 px-20">
            <div className="relative flex flex-col items-center p-2 mt-4 ">
                <div className="px-2 w-full items-center mb-6">
                    <h1 className='text-center font-bold text-primaryTextColor text-[35px] pt-6 '>BY USING FORGEBOT SERVICES </h1>
                    <h1 className='text-center font-bold text-primaryTextColor text-[35px] pb-8'>YOU AGREE TO THE TERMS AND CONDITIONS:</h1>
                    <p className="text-center w-full text-primaryTextColor text-[18px]">
